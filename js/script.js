...
mainAudio.addEventListener("timeupdate", (e)=>{
    ...
    const duration = e.target.duration; // getting playing total song
...
//change loop, shuffle, repeat icon onlcik
...
mainAudio.addEventListener("ended", () => {
    ...
    switch(getText){
        case "repeat":
            ...
            loadMusic(musicIndex); //calling load music function with arguements
            playMusic(); //calling playMusicfunction
            break;
            case "shuffle":
...
//play particular song from the list on click 
...
function playingSong(){
    ...
    let audioTag = allLiTags[j].querySelector (".audio-duration");
        ...
        if(allLiTags[j].classList.contains("playing")){
            ...
            //get that audio duration value and pass to .aduio-duration innertext
